...
# Brief: Training Class, including loading dataset,
#       preprocessing, training, validating, etc.
class ClassTrainer():

    # Brief: Construct ClassTrainer & print the settings
    # Used:  train_classifier.py
    # Input:
    # Output:
    ...
    def setup(self):
        ...
        if self.args.optimizer == 'sgd':
            ...
            self.optimizer = SGDW(self.model.parameters(), lr=self.args.lr, weight_decay=self.args.weight_decay)

        elif self.args.optimizer == 'adabound':
            from utils.adabound import AdaBound
            self.optimizer = AdaBound(self.model.parameters(), lr=self.args.lr, weight_decay=self.args.weight_decay)
    ...
    # Brief: Main training& validating process
    # Used:  train_classifier.py
    # Input:
    # Output:
    def train(self):
    ...
    # Brief: Training part of the process
    # Used:  train
    # Input: epoch, criterion
    # Output:
        ...
        for batch_idx, (inputs, labels) in enumerate(self.dataloaders['train']):
            ...
            with torch.set_grad_enabled(True):
                ...
                if  (epoch % 5==0) and (step%5000==0):#(epoch % 10==0)
                    try:
                        # Show in visdom
                        self.visualize(epoch, C,inputs.cpu(), target.cpu(), fin1.cpu(), fin2.cpu(), fin3.cpu())
                    except:
                        pass
    ...
    # Brief: Validating part of the process
    # Used:  train
    # Input: epoch
    # Output:
    ...
    # Brief: Visualize the training heatmap in Visdom
    # Used: train_epoch
    # Input: epoch, C, input, target, fin1,fin2,fin3
    # Output:
    def visualize(self,epoch, C,input,target,fin1,fin2,fin3):
